...
<body class="respond" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
                    ...
                    <tr>
                        <td align="center">
                            ...
                            <table border="0" align="center" width="590" cellpadding="0" cellspacing="0" class="container590">
                                ...
                                <tr>
                                    <td align="center" height="70" style="height:140px;">
                                        <a href="" style="display: block; border-style: none !important; border: 0 !important;"><img width="300" border="0" style="display: block; width: 300px;" src="https://trendsafrica.co.ke/click2.PNG" alt="" /></a>
                                    </td>
                                </tr>
                                        ...
                                        <table width="360 " border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;"
                                            ...
                                            <tr>
                                                <td width="120" align="center" style="font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                                    <a href="" style="color: #312c32; text-decoration: none;">JOIN</a>
                                                </td>
                                                <td width="120" align="center" style="font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                                    <a href="" style="color: #312c32; text-decoration: none;">CLICK</a>
                                                </td>
                                                <td width="120" align="center" style="font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                                    <a href="" style="color: #312c32; text-decoration: none;">EARN</a>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                ...
                <table border="0" align="center" width="590" cellpadding="0" cellspacing="0" class="container590">
                    ...
                    <tr>
                        <td align="center" style="color: #343434; font-size: 24px; font-family: Quicksand, Calibri, sans-serif; font-weight:700;letter-spacing: 3px; line-height: 35px;"
                            ...
                            <p> <span style="color: #5caad2;">{{ $data['subject'] }}</span></p>
                                            ...
                                            <tr>
                                                <td align="center" style="color: #ffffff; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 22px; letter-spacing: 2px;">
                                                    ...
                                                    <div style="line-height: 22px;">
                                                        <a href="https://clicknets.org/home" style="color: #ffffff; text-decoration: none;">MY ACCOUNT</a>
                                                    </div>
                                                </td>
                                            </tr>
    ...
    <table border="0" width="100%" cellpadding="0" cellspacing="0" bgcolor="2a2e36">
        ...
        <tr>       
            <td align="center" style="background-image: url(https://trendsafrica.co.ke/adsev5.JPG); background-size: cover; background-position: top center; background-repeat: no-repeat;">
                                        ...
                                        <table border="0" align="center" cellpadding="0" cellspacing="0" class="container580">
                                            <tr>
                                                <td align="center" style="color: #cccccc; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 26px;">
                                                    ...
                                                    <div style="line-height: 56px" ><strong style="color: green;">

                                                       <!-- We work hard to ensure your excellence in the ad revenue network.. -->
                                                       </strong>
                                                    </div>
                                                </td>
                                            </tr>
                            ...
                            <table border="0" align="center" width="250" cellpadding="0" cellspacing="0" style="border:2px solid #ffffff;">
                                ...
                                <tr>
                                    <td align="center" style="color: #ffffff; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 22px; letter-spacing: 2px;">
                                        ...
                                        <div style="line-height: 22px;">
                                            <a href="" style="color: yellow; text-decoration: none;" > <h2> The leading revenue booster !</h2></a>
                                        </div>
                                    </td>
                                </tr>
                                            ...
                                            <tr>
                                                <td align="left" style="color: #888888; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 23px;"
                                                    ...
                                                    <div style="color: #333333; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; font-weight: 600; mso-line-height-rule: exactly; line-height: 23px;">
                                                        ...
                                                        Email us: <br/> <a href="mailto:" style="color: #888888; font-size: 14px; font-family: 'Hind Siliguri', Calibri, Sans-serif; font-weight: 400;">contact@clicknets.org</a>
                                            ...
                                            <tr>
                                                <td>
                                                    <table border="0" align="right" cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            <td>
                                                                <a href="https://www.facebook.com/clicknetorg" style="display: block; border-style: none !important; border: 0 !important;"><img width="24" border="0" style="display: block;" src="http://i.imgur.com/Qc3zTxn.png" alt=""></a>
                                                            </td>
                                                            <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                                            <td>
                                                                <a href="https://twitter.com/clicknetorg" style="display: block; border-style: none !important; border: 0 !important;"><img width="24" border="0" style="display: block;" src="http://i.imgur.com/RBRORq1.png" alt=""></a>
                                                            </td>
                                                            <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                                            <td>
                                                                <a href="https://plus.google.com/clicknetorg" style="display: block; border-style: none !important; border: 0 !important;"><img width="24" border="0" style="display: block;" src="http://i.imgur.com/Wji3af6.png" alt=""></a>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                ...
                                <tr>
                                    <td align="left" style="color: #aaaaaa; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                        <div style="line-height: 24px;">
                                            ...
                                            <span style="color: #333333;">ClickNet : All Rights Reserved</span>
