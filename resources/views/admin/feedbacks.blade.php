              ...
              @foreach($feed as $w)
                  <tr>
                     ...
                     {{$w->Subject}}
                      ...
                      <td class="project_progress">
                          <a href="{{route('readfeedback', $w->id)}}" class="btn btn-success btn-sm">Read</a>                     

                      </td>
                      <td class="project_progress">
                      <a href="{{route('replyfeedback', ['id'=>$w->id,'userid'=>$w->UserId])}}" class="btn btn-danger btn-sm">Reply Feed</a>                     
