    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">These page displays all website visits from you to other websites</h3>
                  ...
                  <tr>
                      ...
                      <td class="project-state">
                        @if($w->Returned == 1)
                         ...
                         @elseif ($w->Returned == 0) 
                         <div class="row">
                         <span class="badge badge-info">Work not Returned</span>
                      ...
                      @if($w->Returned == 0) 
                      <td class="project-state">
                      @php $UserId= Crypt::encrypt($w->OwnerId); @endphp

                      <a href="{{route('reportuser', $UserId)}}" class="btn btn-danger btn-sm">Report User</a>                   
                      </td>
                      @endif
                  </tr>
                  @endforeach
